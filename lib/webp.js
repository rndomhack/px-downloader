        ...
        render(options) {
                ...
                promise = promise.then(() => {
                    return new Promise((resolve, reject) => {
                        ...
                        reader.addEventListener("load", () => {
                            frame.buffer = new Uint8Array(reader.result);
            ...
            promise = promise.then(() => {
                ...
                for (const frame of this.frames) {
                    ...
                    const riffChunks = this.readChunks(frame.buffer);
                            ...
                            case "VP8L": {
                                ...
                                switch (chunk.id) {
                                    case "VP8 ": {
                                        ...
                                        console.log(widthMinusOne, heightMinusOne);
                    ...
                    if (!flag) {
                        throw new Error("Can't find VP8 chunk");
                    }
                }

                return new Blob([this.writeChunks([this.createRiffChunk({ type: "WEBP", buffer: this.writeChunks(rebuiltChunks)})])], { "type": "image/png" });
            });
